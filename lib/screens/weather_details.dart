...
class WeatherDetails extends StatelessWidget {
        ...
        return Container(
          ...
          child: Column(
            ...
            children: [
              ...
              // ✅ FIXED GRID - Calculate proper aspect ratio
              _buildDetailGrid(
                context,
                [
                  _DetailItem(
  ...
  Widget _buildDetailGrid(
    ...
    bool isSmallDevice,
    bool isVerySmallDevice,
    double screenWidth,
  ) {
    // ✅ CALCULATE PROPER ASPECT RATIO TO PREVENT OVERFLOW
    // Formula: width / height should give enough space
    final cardPadding = isSmallDevice ? 12.0 : 14.0;
    final spacing = isSmallDevice ? 10.0 : 12.0;
    
    // Calculate available width for each card
    final availableWidth = (screenWidth - 32 - 32 - spacing) / 2; // margin + padding + spacing
    
    // Calculate needed height for content
    final iconSize = 20.0;
    final iconPadding = 8.0 * 2;
    final textHeight = isVerySmallDevice ? 60.0 : 70.0;
    final neededHeight = cardPadding * 2 + iconPadding + iconSize + textHeight + spacing * 2;
    
    // Calculate aspect ratio
    final aspectRatio = availableWidth / neededHeight;
    ...
    return GridView.builder(
      ...
      gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
        crossAxisCount: 2,
        childAspectRatio: aspectRatio.clamp(1.2, 1.6), // ✅ SAFE RANGE
      ...
      itemBuilder: (context, index) {
        ...
        return _buildEnhancedDetailCard(
          item,
          textColor,
          secondaryColor,
          currentTime,
  ...
  Widget _buildEnhancedDetailCard(
    ...
    return Container(
      padding: EdgeInsets.all(isSmallDevice ? 12 : 14),
      decoration: BoxDecoration(
